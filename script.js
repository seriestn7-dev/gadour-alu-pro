...
window.calculateTotalDevis = function() {
    ...
    for (const it of devis) {
        ...
        if (it.product === "monobloc") {
            ...
            mat.a_Gallet += 4*Q; mat.a_Fermeture += 2*Q; mat.a_Kit_Etancheite += 1*Q;
            ...
            if (is2V) {
                ...
                mat.a_Ecer_Danimo_P += 6 * Q;
                mat.a_Ecer_Danimo_G += 6 * Q;
                mat.a_Ecer_Font += 4 * Q;
                mat.a_Ecer_Tall_7did += 8 * Q;
                ...
                mat.a_Cremone += 1 * Q;
                mat.a_Kit_Cremone += 1 * Q;
                mat.a_Ecer_Font += 4 * Q; mat.a_Ecer_Tall_7did += 4 * Q;
                mat.a_Ecer_Danimo_G += 4 * Q; mat.a_Ecer_Danimo_P += 4 * Q;
                mat.a_Joint_Batman += ((H + L) * 2 / 100) * Q;
            }
